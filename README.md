...
for Android: press on the screen to move forward and face the direction to control the direction you want to turn.
for UnityHub on Windows: Hold down Ctl + Alt key and left click to control your movement and rotation in the game  
